...
|---|---|---|
| Marketing version | `1.0.8` | `EXPO_APP_VERSION` |
| Android versionCode (both apps) | `110` | `EXPO_ANDROID_VERSION_CODE` |
| Driver iOS buildNumber | `19` | `EXPO_DRIVER_IOS_BUILD_NUMBER` |
| Client iOS buildNumber | `19` | `EXPO_CLIENT_IOS_BUILD_NUMBER` |
