...
const appVersion = process.env.EXPO_APP_VERSION || "1.0.13";
const currentAndroidVersionCode = Number(process.env.EXPO_ANDROID_VERSION_CODE || 122);
...
function getVariantConfig(variant) {
  ...
  return {
    ...
    androidVersionCode: currentAndroidVersionCode,
    iosBuildNumber: getIosBuildNumber("driver", "21"),
